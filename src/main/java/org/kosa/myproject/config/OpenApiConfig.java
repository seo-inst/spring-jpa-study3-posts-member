...
@Tag(name = "Community Management" , description = "커뮤티니 서비스 API") // OpenApi / Swagger Web UI 에 보여줄 내용
public class OpenApiConfig {
    @Bean // 현 메서드 반환 객체를 스프링 bean 으로 생성해 관리
    public OpenAPI customOpenAPI(){
        return new OpenAPI()
                .info(new Info()
                        .title("Community Management API")
                        .description("커뮤티니 서비스를 위한  REST API")
                        .version("1.0.0")
